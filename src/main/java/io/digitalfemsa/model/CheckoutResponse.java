...
public class CheckoutResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedPaymentMethods, canNotExpire, emailsSent, expiresAt, failureUrl, id, livemode, metadata, name, needsShippingContact, _object, paidPaymentsCount, paymentsLimitCount, recurrent, slug, smsSent, startsAt, status, successUrl, type, url);
  }
