...
public class OrderResponseCheckout {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowedPaymentMethods, canNotExpire, emailsSent, expiresAt, failureUrl, id, isRedirectOnFailure, livemode, metadata, name, needsShippingContact, _object, onDemandEnabled, recurrent, slug, smsSent, successUrl, startsAt, status, type, url);
  }
