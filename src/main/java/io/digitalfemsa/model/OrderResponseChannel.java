 ...
 */
@JsonPropertyOrder({
  OrderResponseChannel.JSON_PROPERTY_SEGMENT,
  OrderResponseChannel.JSON_PROPERTY_CHECKOUT_REQUEST_ID,
  OrderResponseChannel.JSON_PROPERTY_CHECKOUT_REQUEST_TYPE,
  OrderResponseChannel.JSON_PROPERTY_ID
})
@JsonTypeName("order_response_channel")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.5.0")
public class OrderResponseChannel {
  ...
  public OrderResponseChannel() { 
  }

  public OrderResponseChannel segment(String segment) {
  ...
  **/
  ...
  public OrderResponseChannel checkoutRequestId(String checkoutRequestId) {
  ...
  **/
  ...
  public OrderResponseChannel checkoutRequestType(String checkoutRequestType) {
  ...
  **/
  ...
  public OrderResponseChannel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this order_response_channel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OrderResponseChannel orderResponseChannel = (OrderResponseChannel) o;
    return Objects.equals(this.segment, orderResponseChannel.segment) &&
        Objects.equals(this.checkoutRequestId, orderResponseChannel.checkoutRequestId) &&
        Objects.equals(this.checkoutRequestType, orderResponseChannel.checkoutRequestType) &&
        Objects.equals(this.id, orderResponseChannel.id);
  }
